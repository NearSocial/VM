...
// async function requestAccessKey(near, accountId, contractName, methodNames, publicKey) {
//   const wallet = await (await near.selector).wallet("near-wallet");

//   const accounts = await wallet.signIn({ contractId: contractName });
//   return accounts;
// }
